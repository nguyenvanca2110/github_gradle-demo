		    ...
		    steps{
		        script {
		            //withKubeConfig([credentialsId: 'AZURE_AKS', serverUrl: '']) {
                        ...
                        sh ('kubectl set image deployment/gradle-demo-app gradle-demo-container=$ACR_GRADLE_DEMO_URL/$APPLICATION_NAME:$COMMIT_HASH --namespace $NAME_SPACE')
                    //}
                }
            }
        }
